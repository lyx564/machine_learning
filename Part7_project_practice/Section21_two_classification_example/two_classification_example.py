...
model.fit(X=rescalerdX, y=Y_train)
#评估模型
rescaled_validationX = scaler.transform(X_validation)
predicitons = model.predict(rescaled_validationX)
print(accuracy_score(Y_validation, predicitons))
print(confusion_matrix(Y_validation, predicitons))
print(classification_report(Y_validation, predicitons))